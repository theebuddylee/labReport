...
def overwrite_more_information(template_path, output_path, member_name, selected_manager):
    try:
        ...
        first_page = doc[0]
        first_page.insert_text((70, 538), f"{manager_name} exclusively for {member_name or 'Not Provided'}", fontsize=18, color=(0.451, 0.451, 0.451))
        first_page.insert_text((70, 577), f"{manager_phone}", fontsize=18, color=(0.451, 0.451, 0.451))
        first_page.insert_text((70, 615), f"{manager_email}", fontsize=18, color=(0.451, 0.451, 0.451))
